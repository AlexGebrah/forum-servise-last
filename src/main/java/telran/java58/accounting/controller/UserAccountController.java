...
public class UserAccountController {
    ...
    public void changePassword(Principal principal, @RequestHeader("X-Password") @Size(min = 4, max = 20, message = "password must be between 6 and 20 characters") String newPassword) {
